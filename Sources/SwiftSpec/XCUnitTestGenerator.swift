...
class XCUnitTestGenerator: UnitTestGenerator {
	...
	func generateUnitTest(feature: Feature, timestamp: Date) -> String {
		var t = ""
		t = t.appendLine(header(timestamp: timestamp))
	...
	func header(timestamp: Date) -> String {
		return header(timestamp: headerTimestampAsString(timestamp: timestamp))
	}

	func header(timestamp: String) -> String {
		return lines([
			"//",
			"// AUTOGENERATED FILE",
